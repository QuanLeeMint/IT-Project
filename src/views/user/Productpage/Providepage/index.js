...
const Aboutpage = () => {
    const form = useRef(); // Sử dụng useRef để tham chiếu đến form
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm(
                'service_4mu3rdx', // Thay bằng Service ID của bạn
                'template_8a2frri', // Thay bằng Template ID của bạn
                form.current, 
                '2Zo8A2jS0AMztEXq4' // Thay bằng Public Key từ EmailJS
            )
            .then((result) => {
